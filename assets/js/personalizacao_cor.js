...
inputCard.addEventListener('input', (e) => aplicarEGravar('--cor-card-azul', e.target.value));
inputFundo.addEventListener('input', (e) => aplicarEGravar('--cor-fundo-primario', e.target.value));
